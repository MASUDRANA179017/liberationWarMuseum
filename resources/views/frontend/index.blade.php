...
<section class="banner-two">
    ...
    <div class="banner-six-slide-dot swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
    ...
    <div class="container">
        ...
        <div class="award">
            <div class="row" id="serviceContainer">
                ...
                @php
                // Image Logic
                $firstImage = isset($exhibition->images) ? $exhibition->images->first() : null;
                $imagePath = $firstImage ? asset('storage/' . $firstImage->image) : asset('assets/images/no-image.jpg');
                ...
                <div class="col-12 col-md-6 mb-4 col-lg-4 service-item {{ $index >= 6 ? 'd-none' : '' }}">
                    <div class="award__single" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <div class="thumb">
                            <a href="{{ $detailsRoute }}">
                                <img src="{{ $imagePath }}" alt="{{ $exhibition->exhibition_title }}" style="width: 100%; height: 250px; object-fit: cover; border-radius: 10px;">
                            </a>
                        </div>
                        ...
                        <div class="content">
                            <div class="award__content">
                                ...
                                <h3 class="mb-3 text-center text-white title-sm" style="font-size: 14px; font-weight: 400;">
            ...
            @if (isset($exhibitions) && $exhibitions->count() > 6)
            <div class="row">
                <div class="col-12">
                    <div class="mt-4 text-center section__cta cta">
                        <a href="{{ route('exhibition.page') }}" class="btn--primary">
                            View All Exhibitions <i class="fa-solid fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-4 col-lg col-md-4 col-6">
                <div class="counter-item">
                    ...
                    <div class="icon-wrapper">
                        <img src="/storage/{{$counter->counter_icon}}" alt="{{ $counter->counter_title }}" style="width: 50px; height: 50px; object-fit: contain;">
                    </div>
...
<section class="team ff-team">
    <div class="container">
        <div class="text-center section-eight-wrapper" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
            <h6 class="sub-title-main"><i class="fa-solid fa-briefcase"></i> Art Exibition</h6>
        ...
        <div class="row">
            ...
            $imagePath = $firstImage ? asset('storage/' . $firstImage->image) : asset('assets/images/no-image.png');
            ...
            <div class="col-lg-4 col-md-6">
                <div class="p-0 property-single-boxarea" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div class="property-list-img-area position-relative">
                        <a href="{{ $detailsRoute }}">
                            <div class="img1 image-anime">
                                <img src="{{ $imagePath }}" alt="{{ $exhibition->exhibition_title }}" style="width: 100%; height: 250px; object-fit: cover;">
                            </div>
                        </a>

                        <div class="top-0 p-2 position-absolute start-0">
                            <span class="badge bg-primary me-1">Exhibition</span>
                        </div>
                    </div>
                    ...
                    <div class="property-details">
                        <p class="m-0 fs-14">
                            <i class="fa-solid fa-user-tie me-1 text-primary"></i> {{ $exhibition->director_name }}
                        </p>
                    </div>
            ...
            <div class="py-5 text-center col-12">
                <p class="text-muted">No exhibitions found.</p>
            </div>
            @endif
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="mt-5 text-center">
                    <a href="{{ route('exhibition.page') }}" aria-label="all exhibitions" title="all exhibitions" class="p-2 px-5 btn--primary">
                        View All Exhibitions <i class="fa-solid fa-arrow-right"></i>
                    </a>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row align-items-center testimonial-six-frist-row">
            <div class="col-xl-6 col-lg-6">
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="overflow-hidden testimonial-six-slide position-relative" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                                        ...
                                        <div class="testimonial-six-bottom">
                                            <div class="testimonial-six-author">
                                                <div class="testimonial-six-author-img">
                                                    <img src="/storage/{{$testimonial->image}}" alt="Anwar Ahmed" style="height: 60px; width: 60px; object-fit: cover;">
                                                </div>
                                                <div class="testimonial-six-author-content">
                                                    <h6>{{$testimonial->client_name}}</h6>
                                                    <p class="mb-0">{{$testimonial->designation}}, {{$testimonial->organization}}</p>
                                                </div>
                                            </div>
                                            <div class="testimonial-six-author-quate">
                                                <span><img src="assets/images/testimonial/testimonial-six-quate.png" alt="quate"></span>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
...
<section class="pt-80 pb-60 blog-main blog cm-details">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-7">
                <div class="text-center section-six-wrapper" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
