   ...
   <div class="container">
      <div class="row">
         <div class="common-banner__content text-center">
            ...
            <h2 class="title-animation">Marketing Engineer Team</h2>
         </div>
      </div>
   </div>
   <div class="banner-bg">
...
<!-- banner section end -->
<!-- Current Committee -->
<section class="team ff-team" id="teamSection">
   <div class="container">
      <div class="section__header text-center" data-aos="fade-up" data-aos-duration="1000">
         <span class="sub-title-main"><i class="fa-solid fa-user-graduate"></i>Executive Committee</span>
         <h2 class="title-animation mt-0">Our Marketing Engineers</h2>
         </h2>
      </div>
      <div class="row">
   ...
   <div class="modal-dialog modal modal-md modal-dialog-scrollable modal-dialog-centered">
      <div class="modal-content">
         <div class="modal-header p-3">
            <h5 class="title-lg fs-20 fw-600" id="clientDetailsModalLabel">Client Details: </span></h5>
