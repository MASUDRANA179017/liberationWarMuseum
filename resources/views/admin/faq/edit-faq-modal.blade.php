                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                   ...
                                   <textarea type="text" class="form-control summernote" id="answer" cols="5" rows="5" name="answer" placeholder="Write Here" value="{{ old('answer', $faq->answer) }}" required>{{$faq->answer}}</textarea>
                                </div>
                             </div>
                        </div>
                    </div>
