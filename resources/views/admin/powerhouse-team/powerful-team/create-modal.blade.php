                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group p-0 pb-2">
                                            ...
                                            <select type="text" class="form-control custom-input" id="create_department" name="department" placeholder="Department">
                                                ...
                                                <option value="Site Engineer Team">IEET Officials Team</option>
                                                <option value="Marketing Engineer Team">IEET Engineers</option>
                                            </select>
                                            <span class="invalid-feedback" role="alert"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="row rounded  custom-border-primary-1 custom-bg-primary-100 p-2">
                                    <div class="col-md-12">
                                        <div class="form-group p-0 pb-2">
                                            ...
                                            <textarea class="form-control custom-input summernote" name="about" id="create_about" cols="30" rows="5"></textarea>
                                            <span class="invalid-feedback" role="alert"></span>
                                        </div>
                                    </div>
                                </div>
