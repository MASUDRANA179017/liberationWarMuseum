                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <a href="javascript:void(0)" 
                                                    class="btn btn-link btn-success btn-lg btn-edit-application"
                                                    data-id="{{ $application->id }}"
                                                    data-title="{{ $application->title }}"
                                                    data-url="{{ $application->url }}"
                                                    data-icon="{{ $application->icon ? asset('storage/' . $application->icon) : '' }}"
                                                    >
...
<script>
    $(document).ready(function(){
        ...
        $('.btn-edit-application').click(function(){
            ...
            // Set form action
            $('#editApplicationForm').attr('action', '/dashboard/application/update/' + appId);
        ...
        $('#edit_icon').change(function(){
            ...
            reader.onload = function(e){
                $('#edit_icon_preview').attr('src', e.target.result).show();
            }
