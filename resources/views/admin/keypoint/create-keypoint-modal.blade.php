<div id="create-keypoint-modal" class="modal fade" tabindex="-1" role="dialog" style="display: none;">
    <div class="modal-dialog-centered modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('keypoint.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                   ...
                                   <textarea type="text" class="form-control summernote" id="description" name="description" cols="5" rows="5" placeholder="Write Here" required></textarea>
                                </div>
                             </div>
                            <div class="col-sm-12 image">
                                <div class="form-group">
                                    <label for="icon">Icon<span class="text-danger">*</span></label>
                                    <input type="file" class="form-control mb-5" id="icon" name="icon" required>
