                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control summernote" id="details" name="details" cols="5" rows="5" placeholder="Write Here" required></textarea>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control custom-input" id="icon" name="icon"
