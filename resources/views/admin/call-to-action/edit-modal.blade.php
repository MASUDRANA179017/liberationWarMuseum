          ...
          <div class="modal-body">
             <div class="card-body">
                   <div class="row">
                     ...
                     <div class="col-sm-12">
                        <div class="form-group">
                           <label for="data_count">Count <span class="text-danger"> *</span></label>
                           <input type="text" class="form-control" name="data_count" value="{{ old('data_count', $action->data_count) }}" placeholder="Enter Count" required/>
                        </div>
                     </div>
                     <div class="col-sm-12">
                        <div class="form-group">
                           <label for="counter_symbol">Counter Symbol <span class="text-danger"> *</span></label>
                           <input type="text" class="form-control" name="counter_symbol" value="{{ old('counter_symbol', $action->counter_symbol) }}" placeholder="Enter counter symbol" required/>
                        </div>
                     </div>
                     <div class="col-sm-12">
                        <div class="form-group">
                           <label for="short_description">Short Text<span class="text-danger"> *</span></label>
                           <input type="text" class="form-control" name="short_description" value="{{ old('short_description', $action->short_description) }}" placeholder="Enter title" required/>
                        </div>
                     </div>
